 ...
 * IPP:  Exercise 5.12
 * Problems: 
 * 	b. Modify the matrix-vector multiplication program so that each thread
 *    	uses private storage for its part of y, it should copy its private
 *    	storage into the shared variable.
 * 	
